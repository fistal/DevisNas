...
\t\t\t  <button type=\"button\" class=\"btn btn-danger\" href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("nasApp_annuleDevis", array("idDevis" => $this->getAttribute((isset($context["devis"]) ? $context["devis"] : $this->getContext($context, "devis")), "id"))), "html", null, true);
...
\t\t<tr>
\t\t\t<td>
\t\t\t\tHonoraires autres spécialités <br>
\t\t\t\t<div style=\"font-size:11px; color: grey;\">
\t\t\t\t\t";
        // line 126
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["listeHonoraires"]) ? $context["listeHonoraires"] : $this->getContext($context, "listeHonoraires")));
        foreach ($context['_seq'] as $context["_key"] => $context["honoraire"]) {
            // line 127
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["honoraire"]) ? $context["honoraire"] : $this->getContext($context, "honoraire")), "honoraire"), "type"), "html", null, true);
            echo "<br>
\t\t\t\t\t";
        }
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["honoraire"]) {
            // line 135
            echo "\t\t\t\t\t\t";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["honoraire"]) ? $context["honoraire"] : $this->getContext($context, "honoraire")), "mnt"), "html", null, true);
            echo " €<br>
\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  310 => 165,  305 => 162,  297 => 157,  293 => 156,  287 => 154,  285 => 153,  280 => 150,  278 => 149,  268 => 142,  261 => 137,  252 => 135,  248 => 134,  243 => 132,  238 => 129,  229 => 127,  225 => 126,  216 => 120,  209 => 116,  202 => 112,  195 => 108,  188 => 104,  165 => 84,  158 => 80,  151 => 76,  140 => 72,  133 => 68,  122 => 59,  113 => 53,  108 => 51,  101 => 46,  99 => 45,  96 => 44,  93 => 43,  86 => 40,  83 => 39,  77 => 35,  65 => 27,  56 => 21,  43 => 10,  41 => 9,  33 => 3,  30 => 2,);
    }
}
