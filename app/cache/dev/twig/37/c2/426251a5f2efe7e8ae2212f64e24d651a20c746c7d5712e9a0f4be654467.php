...
class __TwigTemplate_37c2426251a5f2efe7e8ae2212f64e24d651a20c746c7d5712e9a0f4be654467 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_b5a3d0f1300501967a67f78c8e012fc46fa397fd7667f22ef31eb1504a66e4fd"] = $this;
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "data"), "forms"))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 96
                echo "                    ";
                echo $context["__internal_b5a3d0f1300501967a67f78c8e012fc46fa397fd7667f22ef31eb1504a66e4fd"]->getform_tree_entry($this->getContext($context, "formName"), $this->getContext($context, "formData"));
                echo "
                ";
            }
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 102
                echo "                ";
                echo $context["__internal_b5a3d0f1300501967a67f78c8e012fc46fa397fd7667f22ef31eb1504a66e4fd"]->getform_tree_details($this->getContext($context, "formName"), $this->getContext($context, "formData"));
                echo "
            ";
            }
            $_parent = $context['_parent'];
